 ...
 * 
 * <p>Esta clase implementa el patrón Template Method, donde el método {@link #importar(String)}
 * define el algoritmo general de importación, delegando la lógica específica de procesamiento
 * de cada fila al método abstracto {@link #procesarFila(Map, int)}.</p>
 * 
 * <p>Proporciona métodos utilitarios comunes para la extracción y validación de datos
 * que pueden ser reutilizados por las clases hijas.</p>
 * 
...
public abstract class CsvReader<T> {
     ...
     * 
     * <p>Este método sigue el patrón Template Method:</p>
     * <ol>
     *   <li>Lee el archivo CSV usando {@link CsvManager}</li>
     *   <li>Valida que existan datos</li>
     *   <li>Procesa cada fila individualmente usando {@link #procesarFila(Map, int)}</li>
     ...
     * 
     * <p>Este método debe ser implementado por las clases hijas para definir
     * la lógica específica de conversión de los datos de la fila a un objeto.</p>
     * 
     * <p><strong>Responsabilidades del método:</strong></p>
     * <ul>
     *   <li>Extraer los valores necesarios de la fila usando {@link #obtenerValor(Map, String)}</li>
     *   <li>Validar que los datos sean correctos</li>
     *   <li>Crear y retornar el objeto T, o null si los datos no son válidos</li>
     * </ul>
     * 
     * @param fila Mapa con los datos de la fila (clave=nombre columna, valor=dato)
     ...
     * 
     * <p>Busca la clave especificada en el mapa sin importar mayúsculas/minúsculas
     * y retorna el valor limpio (sin espacios al inicio/final).</p>
     * 
     ...
     * 
     * <p>Similar a {@link #obtenerValor(Map, String)}, pero retorna null
     * en lugar de cadena vacía cuando el valor no existe o está vacío.</p>
     * 
     * @param fila Mapa con los datos de la fila
     * @param claveBuscada Nombre de la columna a buscar
     ...
     * 
     * <p>Método utilitario que acepta un número variable de argumentos
     * y verifica que ninguno sea null o cadena vacía.</p>
     * 
     * @param datos Campos a validar (varargs)
     * @return true si todos los campos son válidos (no null y no vacíos), false en caso contrario
     * 
     * @example
     * <pre>
